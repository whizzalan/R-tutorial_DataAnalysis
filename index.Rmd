...
m32 <- gam(log10(房價)~s(面積)+車位+s(屋齡)+型態+行政區, data=dat1)
# Compare adjusted R-squared, 越趨近1模型配適度越好
data.frame("linear model"=summary(m31)$adj.r.sq,"additive model"=summary(m32)$r.sq)
```
...
<img class=center src=figure/random_forest.png style="width: 800px;">
